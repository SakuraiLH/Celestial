...
string Celestial_Prefix = "Celestial > ";

string Celestial_Access_Denial = Celestial_Prefix + "欸 欸 (′～`;) 你不是管理呢, Celestial 不認識你啊";
string Celestial_Action_Success = Celestial_Prefix + "操作成功執行! (∠・ω< )";

string Celestial_Anti_Recall_Enabled = Celestial_Prefix + "撤回内容全部给我看光光～(∠・ω< )⌒★";
