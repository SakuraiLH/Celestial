...
string Celestial_Minor_Version = "200";
string Celestial_Version = "Celestial " + Celestial_Stable + ' ' + Celestial_Short_Version + '(' + Celestial_Minor_Version + ')' + " By SakuraiLH(GitHub)" + '\n'
